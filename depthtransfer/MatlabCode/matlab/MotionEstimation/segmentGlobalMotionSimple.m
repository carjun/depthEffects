function M = segmentGlobalMotionSimple(imgs, flows) %#ok<INUSD>
%SEGMENTGLOBALMOTIONSIMPLE Performs a binary segmentation of moving pixels
...
% segmentation comes from thresholding optical flow values.
%
% Input:
...
%%%%%%%%%%%   Begin segmentGlobalMotionSimple   %%%%%%%%%%%%%%%%%%%%%%%%%%%
    K = size(imgs,4);
    ...
    %Motion segmentation heuristic (same as in segmentMotionSimple.m)
